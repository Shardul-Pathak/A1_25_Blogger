      ...
      >
        <Toolbar>
          ...
          <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
            <MenuItem onClick={handleMenuClose}><Link to="/accountpanel" style={{ textDecoration: 'none', color: 'black' }}>Profile</Link></MenuItem>
            <MenuItem onClick={handleMenuClose}><Link to="/logout" style={{ textDecoration: 'none', color: 'black' }}>Logout</Link></MenuItem>
          </Menu>
        </Toolbar>
      </AppBar>
